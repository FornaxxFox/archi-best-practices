...
export const milestones = [
  ...
  { phase: "M4", status: "进行中", title: "生产级知识基础设施", summary: "在保持开放和可追溯的前提下，接入更多资料来源。", deliverables: ["来源 intake 与可配置抓取边界", "D1 证据登记与复查接口", "逐案例哈希、数据集版本与变更记录", "鉴权、配额与团队空间", "可选的用户自有模型工作流"] },
];
